...
public class MetaData
{
    ...
    public MetaData()
    {
        ...
        PrefabMappingAdd(16, FIXED_SIZE_TERRAIN_OBJECTS + "Hedgehog_Shelter_01");
        ...
        PrefabMappingAdd(38, STRETCHABLE_ONE_METER_PREFAB_RESOURCES_PATH + "Wild_Corridor_01");
        ...
        PrefabMappingAdd(56, FIXED_SIZE_TERRAIN_OBJECTS + "Hedgehog_Shelter_01");
        ...
        PrefabMappingAdd(78, STRETCHABLE_ONE_METER_PREFAB_RESOURCES_PATH + "Wild_Corridor_01");
        ...
        prefab_fixed_size_widths.Add(16, 3);
        ...
        prefab_fixed_size_widths.Add(56, 3);
        ...
        prefab_fixed_size_lengths.Add(16, 2);
        prefab_fixed_size_lengths.Add(25, 4);
        prefab_fixed_size_lengths.Add(28, 4);
        prefab_fixed_size_lengths.Add(56, 2);
